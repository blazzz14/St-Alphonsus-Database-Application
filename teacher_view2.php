...
// Retrieve selected teacher ID
$selectedTeacherId = $_GET['teacherId'];

// View teacher information
$viewQuery = "SELECT * FROM teachers WHERE `Teacher ID` = '$selectedTeacherId'";
...
if ($viewResult) {
    // Display teacher information in a table
    echo "<table>";
    ...
    echo "Error viewing teacher information: " . mysqli_error($conn);
}
